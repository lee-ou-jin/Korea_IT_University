    ...
    return (
        <nav className="wrapper">
            ...
            <Link to="/license" className="nav-link" onClick={() => setActiveNav(2)}>
                <div>
                    <FontAwesomeIcon icon="medal" className={activeNav === 2 ? "nav-item active" : "nav-item"} />
                </div>
            </Link>
            <Link to="/write" className="nav-link" onClick={() => setActiveNav(3)}>
                <div>
                    <FontAwesomeIcon icon="plus" className={activeNav === 3 ? "nav-item active" : "nav-item"} />
                </div>
            </Link>
            <Link to="/notice" className="nav-link" onClick={() => setActiveNav(4)}>
                <div>
                    <FontAwesomeIcon icon="compass" className={activeNav === 4 ? "nav-item active" : "nav-item"} />
                </div>
            </Link>
